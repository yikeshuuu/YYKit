...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (* _Nonnull NS_NOESCAPE)(id, id, void *))comparator context:(void *)context {
    LOCK(NSArray * arr = [_arr sortedArrayUsingFunction:comparator context:context]) return arr;
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (* _Nonnull NS_NOESCAPE)(id, id, void *))comparator context:(void *)context hint:(NSData *)hint {
...
- (void)sortUsingFunction:(NSInteger (* _Nonnull NS_NOESCAPE)(id, id, void *))compare context:(void *)context {
