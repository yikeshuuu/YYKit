...
/**
 ...
 @param completionBlock The block invoked on main thread after the save operation completes.
    assetURL: A compatibility URL that identifies the saved asset. It may not be a system-resolvable file/resource URL. If the image is not saved, assetURL is nil.
